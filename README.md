...
- Report screenshots or a short demo
- Data preparation and modeling approach
- Selected DAX measures and design decisions
- Key findings, recommendations, and measurable impact
...
- DAX measures, time intelligence, and KPI design
- Dashboard UX, drill-through, tooltips, and bookmarks
- Row-level security, refresh strategy, and performance optimization
...
projects/
  report-name/
    README.md          # Complete case study
    images/            # Sanitized screenshots
    dax/               # Selected measures as text
    sample-data/       # Optional synthetic or public data only
templates/
  PROJECT_TEMPLATE.md
docs/
...
Only sanitized material is published here. Tenant URLs, customer or employee information, credentials, connection strings, proprietary data, and confidential business metrics must not be committed. A `.pbix` file should only be included when its data is public or fully synthetic and redistribution is permitted.

## Contact

Add your LinkedIn profile, email address, and location here.
